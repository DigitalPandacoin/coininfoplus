...
function toBitcoinJS () {
  ...
  return Object.assign({}, this, {
    ...
    bip32: {
      public: this.versions.bip32.public || 0,
      private: this.versions.bip32.private || 0,
    },
    "bip44": this.versions.bip44,
    pubKeyHash: this.versions.public || 0,
    scriptHash: this.versions.scripthash,
    wif: this.versions.private || 0,
...
function toCoinInfo(coin) {
  var template = {
    ...
    if (!coinCheck.found) {
        ...
        info.versions.scripthash = coin.scripthash
        info.versions.bip32.private = coin.versions.bip32.private
        info.versions.bip32.public = coin.versions.bip32.public
        info.versions.bip44 = coin.versions.bip44
        info.name = coin.name 
        info.unit = coin.unit
        info.messagePrefix = coin.messagePrefix
        return {main: info}
    } else {
